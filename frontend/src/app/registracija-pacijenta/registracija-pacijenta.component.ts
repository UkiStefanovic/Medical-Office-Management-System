...
@Component({
    selector: 'app-registracija-pacijenta',
    templateUrl: './registracija-pacijenta.component.html',
    styleUrls: ['./registracija-pacijenta.component.css']
})
export class RegistracijaPacijentaComponent implements OnInit {

    constructor(private _location: Location, private korisnikService: KorisnikService) { }
    ...
    registracija() {
        ...
        this.korisnikService.dohvatiSveKorisnike().subscribe((svi_korisnici: Korisnik[]) => {
            ...
            if (jedinstveno) {
                ...
                this.korisnikService.registrujPacijenta(
                    this.korisnicko_ime,
                    this.lozinka,
                    this.ime,
                    this.prezime,
